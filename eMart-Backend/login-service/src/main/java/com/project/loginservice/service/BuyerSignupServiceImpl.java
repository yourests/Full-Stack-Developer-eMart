...
public class BuyerSignupServiceImpl implements BuyerSignupService {
	...
	@Override
	public List<SellerSignupPojo> getSeller() {
		List<SellerSignupPojo> sellerSignupPojo = new ArrayList<SellerSignupPojo>();
		List<SellerSignupEntity> allSellerEntity = sellerDao.findAll();
		if(allSellerEntity != null) {
			for (SellerSignupEntity sellerEntity : allSellerEntity) {
				SellerSignupPojo sellerPojo = new SellerSignupPojo();
				sellerPojo.setId(sellerEntity.getId());
				sellerPojo.setUsername(sellerEntity.getUsername());
				sellerPojo.setPassword(sellerEntity.getPassword());
				sellerPojo.setCompany(sellerEntity.getCompany());
				sellerPojo.setBrief(sellerEntity.getBrief());
				sellerPojo.setGst(sellerEntity.getGst());
				sellerPojo.setAddress(sellerEntity.getAddress());
				sellerPojo.setEmail(sellerEntity.getEmail());
				sellerPojo.setWebsite(sellerEntity.getWebsite());
				sellerPojo.setContact(sellerEntity.getContact());
				sellerSignupPojo.add(sellerPojo);
			}
		}
